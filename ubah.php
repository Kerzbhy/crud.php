...
<?php include "koneksi.php";
    ...
    $query="SELECT * FROM tbl_buku WHERE id_buku='$_GET[id_buku]'";
...
<body>
    ...
    <div class="container mt-4">
        <form action="aksiubah.php" method="POST">
            <input type="hidden" class="form-control" id="id_buku" name="id_buku" value="<?php echo $_GET['id_buku']?>">
            <div class="mb-3 row">
